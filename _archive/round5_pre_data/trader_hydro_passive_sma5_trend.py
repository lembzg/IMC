...
class Trader:
    ...
    # HYDROGEL_PACK — passive maker with SMA-5 fair value, inventory skew, trend filter
    def hydro(self, state: TradingState, shared: dict):
        ...
        # SMA-5 fair value
        bid_hist = shared.get("hydro_bid_hist", [])
        ask_hist = shared.get("hydro_ask_hist", [])
        ...
        shared["hydro_bid_hist"] = bid_hist
        shared["hydro_ask_hist"] = ask_hist
        ...
        prev_mid = shared.get("hydro_prev_mid", fair_value)
        trend = fair_value - prev_mid
        shared["hydro_prev_mid"] = fair_value
